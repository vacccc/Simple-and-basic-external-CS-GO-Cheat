...
DWORD dwbSendPackets = 0xD423A;
DWORD dwppDirect3DDevice9 = 0xA7030;
DWORD find_hud_element = 0x27D64310;
DWORD force_update_spectator_glow = 0x3A3242;
DWORD interface_engine_cvar = 0x3E9EC;
DWORD is_c4_owner = 0x3AFCD0;
...
DWORD set_abs_angles = 0x1D7110;
DWORD set_abs_origin = 0x1D6F50;
} offset;
