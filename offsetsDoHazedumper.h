...
struct offsets
{
    ...
    DWORD dwEntityList = 0x4D5240C;
    DWORD dwForceAttack = 0x318394C;
    DWORD dwForceAttack2 = 0x3183958;
    DWORD dwForceBackward = 0x3183988;
    DWORD dwForceForward = 0x3183964;
    DWORD dwForceJump = 0x51FC0B4;
    DWORD dwForceLeft = 0x318397C;
    DWORD dwForceRight = 0x31839A0;
    DWORD dwGameDir = 0x6296F8;
    DWORD dwGameRulesProxy = 0x526F3AC;
    DWORD dwGetAllClasses = 0xD641F4;
    DWORD dwGlobalVars = 0x58AAD8;
    DWORD dwGlowObjectManager = 0x529A278;
    DWORD dwInput = 0x51A39C8;
    DWORD dwInterfaceLinkList = 0x906E94;
    DWORD dwLocalPlayer = 0xD3DBEC;
    DWORD dwMouseEnable = 0xD43790;
    DWORD dwMouseEnablePtr = 0xD43760;
    DWORD dwPlayerResource = 0x3181CF0;
    DWORD dwRadarBase = 0x518717C;
    DWORD dwSensitivity = 0xD4362C;
    DWORD dwSensitivityPtr = 0xD43600;
    DWORD dwSetClanTag = 0x89FB0;
    DWORD dwViewMatrix = 0x4D43D54;
    DWORD dwWeaponTable = 0x51A4488;
    DWORD dwWeaponTableIndex = 0x325C;
    DWORD dwYawPtr = 0xD433F0;
    DWORD dwZoomSensitivityRatioPtr = 0xD48638;
    DWORD dwbSendPackets = 0xD415A;
    DWORD dwppDirect3DDevice9 = 0xA7030;
    DWORD find_hud_element = 0x28383520;
    DWORD force_update_spectator_glow = 0x3A20E2;
    DWORD interface_engine_cvar = 0x3E9EC;
    DWORD is_c4_owner = 0x3AEB80;
    DWORD m_bDormant = 0xED;
    DWORD m_flSpawnTime = 0xA370;
    DWORD m_pStudioHdr = 0x294C;
    DWORD m_pitchClassPtr = 0x5187418;
    DWORD m_yawClassPtr = 0xD433F0;
    DWORD model_ambient_min = 0x58DE4C;
    DWORD set_abs_angles = 0x1D62D0;
    DWORD set_abs_origin = 0x1D6110;
} offset;