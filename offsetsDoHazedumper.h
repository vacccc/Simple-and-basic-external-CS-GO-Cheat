...
DWORD dwEntityList = 0x4D5344C;
DWORD dwForceAttack = 0x31849A4;
DWORD dwForceAttack2 = 0x31849B0;
DWORD dwForceBackward = 0x31849F8;
DWORD dwForceForward = 0x31849D4;
DWORD dwForceJump = 0x51FD114;
DWORD dwForceLeft = 0x31849EC;
DWORD dwForceRight = 0x3184A10;
DWORD dwGameDir = 0x6296F8;
DWORD dwGameRulesProxy = 0x527040C;
DWORD dwGetAllClasses = 0xD652BC;
DWORD dwGlobalVars = 0x58AAD8;
DWORD dwGlowObjectManager = 0x529B2B8;
DWORD dwInput = 0x51A4A28;
DWORD dwInterfaceLinkList = 0x907734;
DWORD dwLocalPlayer = 0xD3EC5C;
DWORD dwMouseEnable = 0xD44800;
DWORD dwMouseEnablePtr = 0xD447D0;
DWORD dwPlayerResource = 0x3182D30;
DWORD dwRadarBase = 0x51881BC;
DWORD dwSensitivity = 0xD4469C;
DWORD dwSensitivityPtr = 0xD44670;
DWORD dwSetClanTag = 0x89FB0;
DWORD dwViewMatrix = 0x4D44D94;
DWORD dwWeaponTable = 0x51A54E8;
DWORD dwWeaponTableIndex = 0x325C;
DWORD dwYawPtr = 0xD44460;
DWORD dwZoomSensitivityRatioPtr = 0xD496A8;
DWORD dwbSendPackets = 0xD41BA;
DWORD dwppDirect3DDevice9 = 0xA7030;
DWORD find_hud_element = 0x2C553630;
...
DWORD m_pitchClassPtr = 0x5188458;
DWORD m_yawClassPtr = 0xD44460;
